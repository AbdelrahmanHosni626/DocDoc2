...
class __$$FailureImplCopyWithImpl<T, $Res>
    extends _$RegisterStateCopyWithImpl<T, $Res, _$FailureImpl<T>>
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'RegisterState<$T>.failure(errMessage: $errMessage)';
  }
...
abstract class Failure<T> implements RegisterState<T> {
